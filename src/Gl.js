...
export default class Gl {
	...
	addIntersectionPlane() {
		const geometry = new PlaneGeometry(INTERSECTION_PLANE_SIZE, INTERSECTION_PLANE_SIZE)
	...
	addEyes() {
		...
		const refGeo = new PlaneGeometry(EYE_GAP, EYE_GAP, EYE_AMOUNT - 1, EYE_AMOUNT - 1)
